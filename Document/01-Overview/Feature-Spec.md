...
F1–F9·F11 구현 완료 + **제네릭 프로시저(F12) 구현 완료**(`dotnet test DRPC.slnx -c Release` 99개 통과) — 형제 NuGet **MessageProtocol 2.3.1**, **Communication 2.2.1**(CRC32c 무결성·흐름제어·프레임 상한·ConnectTimeout 채택). F10(Template)만 범위 밖.
