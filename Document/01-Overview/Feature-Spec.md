...
F1–F9·F11 구현 완료 + **제네릭 프로시저(F12) 구현 완료**(`dotnet test DRPC.slnx -c Release` 103개 통과) — 형제 NuGet **MessageProtocol 2.3.2**, **Communication 2.3.0**(CRC32c 무결성·흐름제어·프레임 상한·ConnectTimeout·기본 키 경고 채택). F10(Template)만 범위 밖.
