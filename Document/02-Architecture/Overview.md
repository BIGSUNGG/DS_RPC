...
RPC 계층만 구현한다. 전송은 DS_Communication(RUDP), 직렬화는 DS_MessageProtocol — **둘 다 NuGet 안정판 참조**(현재 Communication 2.5.0 · MessageProtocol 2.3.9, 버전 권위는 [[../00-AI/CONTEXT|CONTEXT]]),
